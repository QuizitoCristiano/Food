...
// }) => {
//     return (<>
//         <div className="container-cards-blue">
...
export const Cardstitle = () => {
    ...
    return (<>
        ...
        <div className="school-container2">
            <SectionCarde data_aos="flip-up"
                text="Venha ate aqui"
                titulodapagina="Em um relatório dos nossos trabalhos sobre profissões em
                   alta, 9 dos 15 cargos destacados pertenciam
                  à área de tecnologia`,"
                nomedocards="Back-end"
            />
            <SectionCarde data-aos="flip-down"
                text="Venha ate aqui"
                titulodapagina="Em um relatório dos nossos trabalhos sobre profissões em
                   alta, 9 dos 15 cargos destacados pertenciam
                  à área de tecnologia`,"
